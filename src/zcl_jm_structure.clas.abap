CLASS zcl_jm_structure DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
**********************************************************************
    ...
    INCLUDE TYPE zjms_name    AS name.
    INCLUDE TYPE zjms_address AS address.
...
CLASS ZCL_JM_STRUCTURE IMPLEMENTATION.
...
* Task 1
**********************************************************************
    DATA address TYPE zjms_address.
...
* Task 2
**********************************************************************
    DATA person2 TYPE zjms_person_inc.
